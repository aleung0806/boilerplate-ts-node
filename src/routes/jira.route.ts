...
import { projectController, listController, issueController, projectRoleController, commentController } from '../controllers/jira.controller'
...
export const commentRouter = customRouter<Comment>('/comment', commentController)
